...
public class BatchJHamlTest extends TestCase {
    ...
    private String hamlPath = CURRENT_PATH + SEPERATOR + "unitTest" + SEPERATOR
            + "hamlTest";
    private String hamlLayoutPath = CURRENT_PATH + SEPERATOR + "unitTest"
            + SEPERATOR + "hamlTest" + SEPERATOR + "layouts";
    private String outputPath = CURRENT_PATH + SEPERATOR + "unitTest"
            + SEPERATOR + "outputTest";
    private String scriptPath = CURRENT_PATH + SEPERATOR + "unitTest"
            + SEPERATOR + "scriptTest";
    private String styleSheetPath = CURRENT_PATH + SEPERATOR + "unitTest"
            + SEPERATOR + "styleSheetTest";

    @Before
    public void setUp() {
        Configuration configuration = new Configuration(hamlPath,
                hamlLayoutPath, outputPath, "jsp", scriptPath, styleSheetPath,
                false);
    ...
    public void testGetContentOutput() throws IOException {
        ...
        assertFalse(StringUtils.contains(batchJHaml.getHamlOutput(hamlFile),
                "<html>"));
    }
}
